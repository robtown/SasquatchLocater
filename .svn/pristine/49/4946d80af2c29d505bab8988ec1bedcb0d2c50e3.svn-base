package com.tss.squatch
{
	...
	import com.tss.squatch.FLVEncoderPckg.FileStreamFlvEncoder;
	import com.tss.squatch.FLVEncoderPckg.FlvEncoder;
	import com.tss.squatch.FLVEncoderPckg.VideoPayloadMaker;
	import com.tss.squatch.FLVEncoderPckg.VideoPayloadMakerAlchemy;
	...
	public class FileUtility
	{
		...
		{
			var fTemp:File = new File("/sdcard/geotags/" + aName);
		...
		public function WriteVideo(vid:Video, aName:String, stream:FileStream=null):void
		{
			var fTempFile:File = new File("/sdcard/geotags/" + aName);
			...
			while (stream.bytesAvailable > 0)
				fsStream.writeByte(stream.readByte());
		}
		...
		public function getFiles():Array
		{
			...
			var file:File = File.applicationDirectory.resolvePath("/sdcard/geotags");
//			var file:File = File.applicationDirectory.resolvePath("E:/Projects/TSS/TSS_Corp/images/BioPics/test");
...
//			var file:File = File.applicationDirectory.resolvePath("E:/Projects/TSS/TSS_Corp/images/BioPics/test");
		...
		{
			var file:File = File.applicationDirectory.resolvePath("/sdcard/geotags/" + fname);
//			var file:File = File.applicationDirectory.resolvePath("E:/Projects/TSS/TSS_Corp/images/BioPics/test/" + fname);
			file.deleteFile()
		}
		
		public function deleteMapImages():void
		{
			var mapFolder:File = File.applicationDirectory.resolvePath("/sdcard/mapimages/");
			if (mapFolder.exists)
			{
		...
		{
			var gtFolder:File = File.applicationDirectory.resolvePath("/sdcard/geotags/");
